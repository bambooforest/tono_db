...
It's also set up so that we can easily cite references in the [BibTeX biblography](referencs.bib). For example: @kristoffersen2000 will now appear below in the references section.
