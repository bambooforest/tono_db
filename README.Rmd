---
title: "Supplementary materials for: 'Tonogenesis: a diachronic typology'"
author: "Steven Moran, Etian Grossman and Lilja Maria Sæbø\n"
...
```{r Chord_type_effectOnPitch_Ordering}
...
```{r Chord_type_effectOnPitch_Ordering2}
